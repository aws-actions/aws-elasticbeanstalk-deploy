 ...
 */
export declare function walkFiles(dir: string, zipFileName: string, callback: (entry: WalkEntry) => void, ig?: Ignore, symlinks?: SymlinkMode, baseDir?: string, visited?: Set<string>): void;
/**
