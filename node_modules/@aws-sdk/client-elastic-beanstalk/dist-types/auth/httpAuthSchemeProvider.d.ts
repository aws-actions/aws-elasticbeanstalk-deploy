 ...
 * @internal
 */
export interface ElasticBeanstalkHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<ElasticBeanstalkClientResolvedConfig, HandlerExecutionContext, ElasticBeanstalkHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultElasticBeanstalkHttpAuthSchemeParametersProvider: (config: ElasticBeanstalkClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<ElasticBeanstalkHttpAuthSchemeParameters>;
/**
 * @internal
 */
