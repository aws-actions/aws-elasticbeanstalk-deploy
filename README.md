...
| `poll-interval` | Seconds between environment checks while waiting (5 to `deployment-timeout`). Raise it to make fewer API calls on a long rollout. | `10` update, `20` create, `15` health recovery |
